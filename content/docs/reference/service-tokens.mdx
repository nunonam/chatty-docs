...
subtitle: 'Create service tokens for your ChattyCloud organization.'
---

## Service tokens

ChattyCloud provides the ability to create service tokens for your ChattyCloud organization via the CLI or directly in the UI.

<InfoBlock type='note'>
  Service tokens are not recommended for connecting to production databases. Instead, connect securely to your database
  using ChattyCloud's <a href='https://docs.chatty-cloud.com/concepts/connection-strings'>connection strings</a>.
</InfoBlock>

## Create service tokens using the ChattyCloud UI

### Create a new service token

1. Go to your organization settings page for service tokens: `app.chatty-cloud.com/<org>/settings/service-tokens`
...
A complete list of service token access permissions can be found [here](https://docs.chatty-cloud.com/reference/chatty-cloud-cli#service-tokens-in-organizations).
...
1. Go to the service tokens page for your organization: `app.chatty-cloud.com/<org>/settings/service-tokens`
...
## Create service tokens using the ChattyCloud CLI

Use the ChattyCloud CLI to create and manage service tokens for your ChattyCloud organization.
