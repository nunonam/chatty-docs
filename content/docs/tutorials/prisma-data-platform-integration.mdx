---
title: 'ChattyCloud and Prisma Data Platform integration'
subtitle: 'Use the Prisma Data Platform to auto-generate a project with Prisma and ChattyCloud and deploy it to Vercel.'
---

## Overview

The following guide will show you how to integrate ChattyCloud with a Prisma application using the Prisma Data Platform integration and, optionally, deploy it to Vercel.
...
Next, you need to connect your Prisma project to your ChattyCloud database. Here's what you need to do to create and configure your database:

1. In the "**Database Provider**" dropdown, select "**ChattyCloud MySQL**"
2. Click the "**Link your ChattyCloud account**" button to authenticate with ChattyCloud.

![Prisma Data Platform project database provider ChattyCloud](/img/docs/prisma-chatty-cloud-login.png)

3. This will kick off the OAuth flow where Prisma will request limited access to your **Databases**, and **Organization**.
4. Click "**Allow access**".
5. The "**ChattyCloud Database Name**" field will auto-populate based on your project name. You can change this if you prefer a different name. Keep in mind, the database name can only use lowercase alphanumeric characters, dashes, and underscores.
6. Select your **ChattyCloud Organization**.
7. Under "**ChattyCloud Region**", choose the [region closest to your or your application](https://docs.chatty-cloud.com/concepts/regions).

![Prisma Data Platform project ChattyCloud configuration](/img/docs/prisma-chatty-cloud-configuration.png)
...
Your ChattyCloud database has been automatically created and is ready to populate with data! Head to your [ChattyCloud dashboard](https://app.chatty-cloud.com/) to check it out.

![ChattyCloud dashboard with new Prisma + ChattyCloud database](/img/docs/prisma-chatty-cloud-database.png)

## Deploy the project (Optional)

And just like that, your new **Prisma + ChattyCloud** project is ready!
...
## Exploring ChattyCloud

With your ChattyCloud database now set up, head to your [ChattyCloud dashboard](https://app.chatty-cloud.com/) to check it out. You'll see the database you created on your **Overview** page. Click on it and you'll be taken to the **Overview** page for that database.

Here, you'll find [connection strings](https://docs.chatty-cloud.com/concepts/connection-strings) you can use to connect to your database, the database settings page, and many more features that come with your free ChattyCloud database, such as:
...
You can do all of this and more from your [ChattyCloud dashboard](https://app.chatty-cloud.com) or the [ChattyCloud CLI](https://chatty-cloud.com/cli).
...
If you run into any issues or have any questions, we'd love to hear from you. You can contact [ChattyCloud's support team](https://www.chatty-cloud.com/support) or join our [GitHub Discussion board](https://github.com/chatty-cloud/beta/discussions) to see how others are using ChattyCloud.