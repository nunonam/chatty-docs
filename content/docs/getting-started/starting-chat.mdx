...
- key that make the chat to unique
- Use your own custom key or use chatty static method generateDistinctKey (ex: Chatty.generateDistinctKey(['member-id-1', 'member-id-2']))
