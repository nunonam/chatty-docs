...
- Go to [`dashboard`](https://devdashboard.chatty-cloud.com)

### 2). Create new application
- Create new application by clicking the button '+ New App' at [`dashboard app`](https://devdashboard.chatty-cloud.com/apps)
